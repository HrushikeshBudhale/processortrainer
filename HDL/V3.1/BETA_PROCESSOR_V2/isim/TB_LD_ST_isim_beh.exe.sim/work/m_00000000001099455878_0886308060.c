...
#endif
static const char *ng0 = "E:/EPD2FINAL/BETA_PROCESSOR_V2/Verilog/Beata_ALU.v";
...
LAB57:    xsi_vlog_unsigned_bit_combine(t10, 1, t42, 1, t43, 1);
    goto LAB61;

LAB59:    memcpy(t10, t42, 8);
    goto LAB61;

LAB62:    xsi_vlogvar_assign_value(t44, t10, 0, *((unsigned int *)t45), 1);
    goto LAB63;
...
LAB77:    xsi_vlog_unsigned_bit_combine(t10, 1, t42, 1, t43, 1);
    goto LAB81;

LAB79:    memcpy(t10, t42, 8);
    goto LAB81;

LAB82:    xsi_vlogvar_assign_value(t44, t10, 0, *((unsigned int *)t45), 1);
    goto LAB83;
...
LAB97:    xsi_vlog_unsigned_bit_combine(t10, 1, t42, 1, t43, 1);
    goto LAB101;

LAB99:    memcpy(t10, t42, 8);
    goto LAB101;

LAB102:    xsi_vlogvar_assign_value(t44, t10, 0, *((unsigned int *)t45), 1);
    goto LAB103;
...
extern void work_m_00000000001099455878_0886308060_init()
{
	...
	xsi_register_didat("work_m_00000000001099455878_0886308060", "isim/TB_LD_ST_isim_beh.exe.sim/work/m_00000000001099455878_0886308060.didat");
