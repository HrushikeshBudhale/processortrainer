...
class asm:
    ...
    def __translate(self, op, destinationReg, sourceReg, literal):
        ...
        if type(literal) is str:    # i.e. literal is sourceReg
            text += format(self.__opcode[op],'06b') + format(int(destinationReg[1:]),'05b')
            text += format(int(sourceReg[1:]),'05b') + format(int(literal[1:]),'05b')
            text += format(0,'011b')
        else:   # of type int 
            text += format(self.__opcode[op+1],'06b') + format(int(destinationReg[1:]),'05b')
            text += format(int(sourceReg[1:]),'05b') + format(self.__twos_compliment(literal),'016b')
        text += '\n'
        return text
    ...
    def ADD(self, destinationReg, sourceReg, literal, title=None):
        ...
        self.__src.append(self.__translate(0, destinationReg, sourceReg, literal))
    ...
    def AND(self, destinationReg, sourceReg, literal, title=None):
        ...
        self.__src.append(self.__src.append(self.__translate(2, destinationReg, sourceReg, literal)))
    ...
    def B(self, literal, title=None):
        ...
        if literal in self.__tags:
            ...
            self.__src.append(self.__translate(3, destinationReg, sourceReg, literal))
        else:
            self.__src.append('-')
            new_str = 'A.B(\'' + literal + '\')'
    ...
    def BZ(self, sourceReg, literal, title=None):
        ...
        if literal in self.__tags:
            ...
            self.__src.append('-')
            new_str = 'A.BZ(\'' + sourceReg + '\',\''+ literal + '\')'
            self.__remaining[self.__line] = new_str
    ...
    def BNZ(self, sourceReg, literal, title=None):
        ...
        if literal in self.__tags:
            literal = self.__tags[literal] - self.__line - 1
            self.__src.append(self.__translate(4, destinationReg, sourceReg, literal))
        else:
            self.__src.append('-')
            new_str = 'A.BNZ(\'' + sourceReg + '\',\''+ literal + '\')'
            self.__remaining[self.__line] = new_str
    ...
    def CMPEQ(self, destinationReg, sourceReg, literal, title=None):
        ...
        self.__src.append(self.__translate(6, destinationReg, sourceReg, literal))
    ...
    def CMPLE(self, destinationReg, sourceReg, literal, title=None):
        ...
        self.__src.append(self.__translate(8, destinationReg, sourceReg, literal))
    ...
    def CMPLT(self, destinationReg, sourceReg, literal, title=None):
        ...
        self.__src.append(self.__translate(10, destinationReg, sourceReg, literal))
    ...
    def DIV(self, destinationReg, sourceReg, literal, title=None):
        ...
        self.__src.append(self.__translate(12, destinationReg, sourceReg, literal))
    ...
    def JMP(self, destinationReg,  title=None):
        ...
        self.__src.append(self.__translate(13, sourceReg, destinationReg, literal))
    ...
    def LOAD(self, destinationReg, sourceReg, literal, title=None):
        ...
        self.__src.append(self.__translate(14, destinationReg, sourceReg, literal))
    ...
    def LOADR(self, destinationReg, literal, title=None):
        ...
        self.__src.append(self.__translate(15, destinationReg, sourceReg, literal))
    ...
    def MUL(self, destinationReg, sourceReg, literal, title=None):
        ...
        self.__src.append(self.__translate(17, destinationReg, sourceReg, literal))
    ...
    def OR(self, destinationReg, sourceReg, literal, title=None):
        ...
        self.__src.append(self.__translate(19, destinationReg, sourceReg, literal))
    ...
    def SHL(self, destinationReg, sourceReg, literal, title=None):
        ...
        self.__src.append(self.__translate(21, destinationReg, sourceReg, literal))
    ...
    def SHR(self, destinationReg, sourceReg, literal, title=None):
        ...
        self.__src.append(self.__translate(23, destinationReg, sourceReg, literal))
    ...
    def SRA(self, destinationReg, sourceReg, literal, title=None):
        ...
        self.__src.append(self.__translate(25, destinationReg, sourceReg, literal))
    ...
    def SUB(self, destinationReg, sourceReg, literal, title=None):
        ...
        self.__src.append(self.__translate(27, destinationReg, sourceReg, literal))
    ...
    def STORE(self, sourceReg, destinationReg, literal, title=None):
        ...
        self.__src.append(self.__translate(28, sourceReg, destinationReg, literal))
    ...
    def XOR(self, destinationReg, sourceReg, literal, title=None):
        ...
        self.__src.append(self.__translate(30, destinationReg, sourceReg, literal))
...
# Create object for assembler
A = asm()
# =============================================================================
# # Read the file to find all the tags and constants 
# A.scan_file('input.txt')
# =============================================================================
